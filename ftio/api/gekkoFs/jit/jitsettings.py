...
class JitSettings():
    ...
    def set_variables(self):
        # job allocation call
        self.alloc_call_flags = "--overcommit --oversubscribe --partition parallel -a nhr-admire --job-name jit --no-shell --self.exclude=cpu0082"
        # self.alloc_call_flags = "--overcommit --oversubscribe --partition largemem -a nhr-admire --job-name jit --no-shell --self.exclude=cpu0082"
