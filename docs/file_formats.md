...
| `examples/tmio/HACC-IO/9216.json` | JSON | HACC cosmology simulation, 9216 ranks | `ftio examples/tmio/HACC-IO/9216.json` |
...
# Wavelet analysis on the HACC trace
ftio examples/tmio/HACC-IO/9216.json -tr wave_disc -e no
